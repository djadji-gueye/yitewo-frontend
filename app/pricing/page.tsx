          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 24, flexWrap: "wrap" }}>
            ...
            <div style={{ flex: "0 0 auto", display: "flex", flexDirection: "column", gap: 10, alignItems: "center" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 14, padding: "20px 28px", textAlign: "center" }}>
                ...
                <p style={{ fontFamily: "Syne", fontWeight: 800, fontSize: 22 }}>+221 76 780 19 29</p>
        ...
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
            {[
              ...
              { q: "Comment se passe l'activation après paiement ?", r: "Vous envoyez le montant via Wave ou Orange Money au +221 76 780 19 29, puis vous nous envoyez un message WhatsApp avec votre nom et votre plan. Notre équipe active votre compte sous 24 heures et vous envoie une confirmation." },
