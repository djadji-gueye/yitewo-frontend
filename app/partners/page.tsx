...
const PARTNER_TYPES = [
  {
    ...
    icon: "🏪",
    label: "Marchand",
    desc: "Épicerie, supérette, boutique, alimentation générale",
  ...
  },
  {
    ...
    icon: "🍽️",
    label: "Restaurant",
    desc: "Restaurant, fast-food, traiteur, cuisine à emporter",
  ...
  },
  {
    ...
    desc: "Plombier, électricien, ménage, coiffeur, jardinage…",
...
export default function PartnersPage() {
  ...
  return (
    <div style={{ background: "var(--surface)", minHeight: "100vh", fontFamily: "DM Sans, sans-serif" }}>
      ...
      {/* ── HERO ── */}
      <div style={{
        background: "linear-gradient(135deg, #0a0a1a 0%, #1a1a3e 50%, #2d1a5e 100%)",
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 680, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "Syne, sans-serif", fontWeight: 800, fontSize: "clamp(26px,5vw,44px)", color: "#fff", marginBottom: 16, lineHeight: 1.2 }}>
            ...
            <span style={{ color: "var(--brand)" }}>avec Yitewo</span>
          </h1>
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: 15, lineHeight: 1.7, marginBottom: 40, maxWidth: 520, margin: "0 auto 40px" }}>
            Rejoignez des centaines de commerçants, restaurateurs et prestataires qui utilisent Yitewo pour toucher plus de clients partout au Sénégal.
          </p>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 20,
                      border: `2px solid ${isSelected ? pt.color : "var(--border)"}`,
                      padding: "24px 20px",
                      cursor: "pointer",
                      textAlign: "left",
                      transition: "all 0.2s",
                  ...
                  >
                    ...
                    <p style={{ fontSize: 12, color: "var(--muted)", lineHeight: 1.5, marginBottom: 14 }}>{pt.desc}</p>
        ...
        {showForm && selected && (
          <div>
            ...
            <div style={{ background: "#fff", borderRadius: 20, border: "1px solid var(--border)", padding: "32px 28px" }}>
              {selected.key === "prestataire" ? <ServiceProviderForm /> : <PartnerForm forcedType={selected.key === "marchand" ? "Marchand" : "Restaurant"} />}
            </div>
          </div>
        )}
      </div>
