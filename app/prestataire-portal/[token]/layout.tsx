    ...
    <>
      ...
      <div style={{ display: "flex", minHeight: "100vh", background: "#f7f4f2", fontFamily: "DM Sans, sans-serif" }}>
        ...
        <div className="p-main" style={{ flex: 1, marginLeft: 240, display: "flex", flexDirection: "column", minWidth: 0 }}>
          <header style={{ height: 56, background: "#fff", borderBottom: "1px solid #f0ebe8", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 28px", flexShrink: 0 }}>

            <button className="portal-hamburger" onClick={() => setMenuOpen(true)}
              style={{ width: 36, height: 36, borderRadius: 8, border: "1px solid #f0ebe8", background: "#fff", cursor: "pointer", flexDirection: "column", gap: 4, alignItems: "center", justifyContent: "center", display: "none" }}>
